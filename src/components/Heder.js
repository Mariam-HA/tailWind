...
const Heder = () => {
  return (
    <div className="p-4 flex flex-col justify-center items-center">
      <h1 className=" text-center text-3xl text-neutral-700 font-bold border-b border-cyan-900">
        The Coasteal Catch
      </h1>
      <h4 className="text-center text-xl text-neutral-950 font-semibold mt-8">
